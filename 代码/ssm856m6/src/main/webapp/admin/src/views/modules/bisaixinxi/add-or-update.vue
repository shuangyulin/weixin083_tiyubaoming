<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="比赛名称" prop="bisaimingcheng">
          <el-input v-model="ruleForm.bisaimingcheng" 
              placeholder="比赛名称" clearable  :readonly="ro.bisaimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="比赛名称" prop="bisaimingcheng">
              <el-input v-model="ruleForm.bisaimingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="比赛时间" prop="bisaishijian">
          <el-input v-model="ruleForm.bisaishijian" 
              placeholder="比赛时间" clearable  :readonly="ro.bisaishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="比赛时间" prop="bisaishijian">
              <el-input v-model="ruleForm.bisaishijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="比赛地点" prop="bisaididian">
          <el-input v-model="ruleForm.bisaididian" 
              placeholder="比赛地点" clearable  :readonly="ro.bisaididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="比赛地点" prop="bisaididian">
              <el-input v-model="ruleForm.bisaididian" 
                placeholder="比赛地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="比赛内容" prop="bisaineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.bisaineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.bisaineirong" label="比赛内容" prop="bisaineirong">
                    <span v-html="ruleForm.bisaineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bisaididian = true;
          ...
          if(o=='bisaineirong'){
            this.ruleForm.bisaineirong = obj[o];
	    this.ro.bisaineirong = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.bisaineirong = this.ruleForm.bisaineirong.replace(reg,'../../../ssm856m6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
