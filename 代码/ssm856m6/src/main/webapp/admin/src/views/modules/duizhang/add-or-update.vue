<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="队长账号" prop="duizhangzhanghao">
          <el-input v-model="ruleForm.duizhangzhanghao" 
              placeholder="队长账号" clearable  :readonly="ro.duizhangzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="队长账号" prop="duizhangzhanghao">
              <el-input v-model="ruleForm.duizhangzhanghao" 
                placeholder="队长账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="队长姓名" prop="duizhangxingming">
          <el-input v-model="ruleForm.duizhangxingming" 
              placeholder="队长姓名" clearable  :readonly="ro.duizhangxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="队长姓名" prop="duizhangxingming">
              <el-input v-model="ruleForm.duizhangxingming" 
                placeholder="队长姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	zhaopian : false,
      ...
      rules: {
          duizhangzhanghao: [
                { required: true, message: '队长账号不能为空', trigger: 'blur' },
          ],
          mima: [
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `duizhang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.duizhangCrossAddOrUpdateFlag = false;
                  this.parent.search();
